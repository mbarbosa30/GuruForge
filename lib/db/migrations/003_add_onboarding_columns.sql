...
-- Backfill: mark all existing connections as already onboarded so they skip the flow
UPDATE telegram_connections SET onboarding_completed = true WHERE status = 'active';
